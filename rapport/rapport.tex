...
Le meilleur modèle retenu est le \textbf{Random Forest (tuné)} avec les hyperparamètres suivants~: 500 arbres, profondeur max 8, \texttt{min\_samples\_leaf} = 5, \texttt{max\_features} = 0,4.
...
\midrule
$R^2$ (prix réel) & 0,3068 \\
RMSE & 4\,265\,671 MRU \\
MAE & 1\,738\,479 MRU \\
Erreur relative médiane & 27,9\,\% \\
Prédictions à $< 30\,\%$ d'erreur & 55,0\,\% \\
Prédictions à $< 50\,\%$ d'erreur & 74,7\,\% \\
\bottomrule
\end{tabular}
\end{table}
